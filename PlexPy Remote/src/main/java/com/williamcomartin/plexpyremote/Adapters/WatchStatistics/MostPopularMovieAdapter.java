...
public class MostPopularMovieAdapter extends RecyclerView.Adapter<MostPopularMovieAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            vPlays = itemView.findViewById(R.id.standard_statistics_card_quantity);
    ...
    public MostPopularMovieAdapter(List<StatisticsModels.StatisticsRow> statisticsItems) {
        this.statisticsItems = statisticsItems;
    }

    @Override
    public MostPopularMovieAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MostPopularMovieAdapter.ViewHolder viewHolder, int position) {
