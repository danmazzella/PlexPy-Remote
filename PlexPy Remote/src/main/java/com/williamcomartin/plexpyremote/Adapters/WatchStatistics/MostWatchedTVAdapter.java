...
public class MostWatchedTVAdapter extends RecyclerView.Adapter<MostWatchedTVAdapter.ViewHolder> {
    ...
    public MostWatchedTVAdapter(List<StatisticsModels.StatisticsRow> statisticsItems) {
        this.statisticsItems = statisticsItems;
    }

    @Override
    public MostWatchedTVAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MostWatchedTVAdapter.ViewHolder viewHolder, int position) {
