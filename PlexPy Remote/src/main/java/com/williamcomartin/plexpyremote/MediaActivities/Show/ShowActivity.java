...
public class ShowActivity extends NavBaseActivity {
    ...
    protected void setupPager() {
        ...
        ShowPagerAdapter pagerAdapter = new ShowPagerAdapter(getSupportFragmentManager(), extras.getString("RatingKey"));
